function make_help_strings() {
    help_strings = {
        'mtm': {
            'header': "Mark to market", 'explanation':
        ...
        'createcustomtype': {
            'header': 'Custom types', 'explanation':
        ...
        'vaultid': {
            'header': 'Vault and loan ID', 'explanation':
        ...
        'issues': {
            'header': 'Known issues and bugs', 'explanation':
        ...
        'mt': {
            'header': 'Manual transactions', 'explanation':
        ...
        'cpop': {
            'header': 'Counterparty and operation', 'explanation':
        ...
        'start': {
            'header': 'How do I use this thing?', 'explanation':
        ...
        'examples': {
            'header': 'Kinds of transactions you might have', 'explanation':
        ...
        'upload_csv': {
            'header': 'Instructions for CSV uploads', 'explanation':
